...
(function() {
    eval(function(p, a, c, k, e, r) {
        ...
        return p
    }('5.6=5.6||7(8){7 0(9,a){2 1;try{1=b[9](a)}catch(c){3 d.reject(c)}if(1.done){3 1.e}else{3 d.resolve(1.e).then(4,f)}}2 b=8();2 4=0.g(0,\'next\');2 f=0.g(0,\'throw\');3 4()};', [], 17, 'continuer|result|var|return|onFulfilled|window|spawn|function|gen|verb|arg|generator|err|Promise|value|onRejected|bind'.split('|'), 0, {}))
