    ...
    var e = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/"
      ...
      , n = function(r) {
        ...
        f = ""; c < h; ) {
            ...
            } while (c < h && -1 == e);if (-1 == e)
                break;
            do {
                a = t[255 & r.charCodeAt(c++)]
            } while (c < h && -1 == a);if (-1 == a)
                break;
      ...
      , o = function(r) {
        ...
        a = r.length,
        t = 0; t < a; t++)
            (n = r.charCodeAt(t)) >= 1 && n <= 127 ? e += r.charAt(t) : n > 2047 ? (e += String.fromCharCode(224 | n >> 12 & 15),
      ...
      , c = function(r) {
        ...
        t = 0; t < a; )
            ...
            case 14:
                o = r.charCodeAt(t++),
                c = r.charCodeAt(t++),
                e += String.fromCharCode((15 & n) << 12 | (63 & o) << 6 | (63 & c) << 0)
            }
        return e
    }
      , h = function(r) {
        ...
        a = r.length,
        t = 0; t < a; )
            (n = r.charCodeAt(t++).toString(16)).length < 2 && (n = "0" + n),
            e += "\\x" + n + " ",
            t > 0 && t % 8 == 0 && (e += "\r\n");
        return e
    }
